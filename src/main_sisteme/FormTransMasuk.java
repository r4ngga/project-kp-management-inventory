...
public class FormTransMasuk extends javax.swing.JFrame {
    ...
    public FormTransMasuk() {
       ...
       // set_pembeliantotal.setText(Integer.toString(hitungtotalpembeliansemua()));
    }
...
//            }
    ...
    public void caribarang(){
        ...
        String idbrg, nmbrgnya, hrgbrg,stoktersisa;
        ...
        if(!idbrgnya.equals("")){
            ...
            if(idygsama == 0){
                try {
                   Object [] baris = {"ID Barang","Nama Barang","Harga Beli","Stok"};
                  ...
                  ResultSet hasil = sttment.executeQuery(exec_sql);
                    if(hasil.next()){
                       ...
                       + " from tb_barang where id_barang like '" + cari + "' or nama_barang like '%" + cari + "%'";
                        ...
                        hrgbrg=hasil2.getString("harga_beli");
                        stoktersisa=hasil2.getString("stok");
                        String data[]={idbrg,nmbrgnya,hrgbrg,stoktersisa};
