 ...
 * @author Rangga
 */
public class FormTransKeluarAdmn extends javax.swing.JFrame {

    /**
     * Creates new form FormTransKeluarAdmn
     */
...
//                        jtxt_setstokbrg.setText(hasil.getString("stok"));
    ...
    tabel_brgkeluar.setModel(modeltbbrg);
     ...
     jlbl_idusernya.setText(AdminSession.GetU_id_user());
    }
...
//            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormTransKeluarAdmn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
